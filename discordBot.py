"""Bot exemple qui répond à @WyvernNE."""
...
TOKEN = "MzExMjU5MzQ2MzA0NDk5NzEy.C_W_1w.iyo1EnpKc35g0131VsaykKw1lJQ"
...
async def send_message(channel_id, content):
    ...
    #266558346969088002 ID HE ARC
    #309734242085109760 ID Channel #BOT
            ...
            async for msg in ws:
                ...
                if data['op'] == 10:  # Hello
                    ...
                    if data['t'] == "MESSAGE_CREATE":
                        print(data['d'])
                        if data['d']['author']['username'] == 'Wyll Vern' or data['d']['author']['username'] == 'Maël Pedretti' or data['d']['author']['username'] == 'Adrien Mendes':
                            ...
                            if data['d']['content'] == 'What is love?':
                                print('Baby don\'t hurt me... don\'t hurt me... no more...')
                                # On l'attend l'envoi du message ci-dessus.
                                data['d']['content']='Baby don\'t hurt me... don\'t hurt me... no more...'
                                task = asyncio.ensure_future(send_message(data['d']['author']['id'],
                                                                          data['d']['content']))
                            else:

                                data['d']['channel_id']='309734242085109760'
                                task = asyncio.ensure_future(send_message(data['d']['channel_id'],
                                                                          data['d']['content']))
